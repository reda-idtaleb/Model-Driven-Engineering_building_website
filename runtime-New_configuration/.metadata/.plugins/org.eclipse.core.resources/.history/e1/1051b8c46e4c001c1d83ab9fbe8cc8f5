 ...
 *******************************************************************************/
package portail.fil.generator.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/portail/fil/generator/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(portail_pedagogique.Portail_pedagogiquePackage.class)) {
            resourceSet.getPackageRegistry().put(portail_pedagogique.Portail_pedagogiquePackage.eINSTANCE.getNsURI(), portail_pedagogique.Portail_pedagogiquePackage.eINSTANCE);
        }
