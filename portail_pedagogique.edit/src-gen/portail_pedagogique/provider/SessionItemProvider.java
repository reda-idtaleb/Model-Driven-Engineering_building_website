...
/**
 * This is the item provider adapter for a {@link portail_pedagogique.Session} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SessionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTeacherPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Session_teacher_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Session_teacher_feature",
								"_UI_Session_type"),
						Portail_pedagogiquePackage.Literals.SESSION__TEACHER, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Timeinterval feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTimeintervalPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Session_timeinterval_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Session_timeinterval_feature",
								"_UI_Session_type"),
						Portail_pedagogiquePackage.Literals.SESSION__TIMEINTERVAL, true, false, true, null, null,
						null));
	}
	...
	protected void addRoomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Session_room_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Session_room_feature", "_UI_Session_type"),
						Portail_pedagogiquePackage.Literals.SESSION__ROOM, true, false, true, null, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Portail_pedagogiquePackage.Literals.SESSION__TYPE, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Portail_pedagogiquePackage.Literals.SESSION__GROUP);
		}
	...
	public String getText(Object object) {
		SessionKind labelValue = ((Session) object).getType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Portail_pedagogiquePackage.Literals.SESSION__GROUP,
				Portail_pedagogiqueFactory.eINSTANCE.createGroup()));
	}
