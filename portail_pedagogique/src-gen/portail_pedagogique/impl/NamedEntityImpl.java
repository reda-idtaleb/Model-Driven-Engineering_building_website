 ...
 * </p>
 * <ul>
 *   <li>{@link portail_pedagogique.impl.NamedEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedEntityImpl extends EntityImpl implements NamedEntity {
	...
	protected EClass eStaticClass() {
		return Portail_pedagogiquePackage.Literals.NAMED_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Portail_pedagogiquePackage.NAMED_ENTITY__NAME,
					oldName, name));
	}
